  ...
  <div class="container_fluid">
    <div class="row d-flex justify-content-center align-items-center ">
      <div class="col-xl-11">
        ...
        <h3 class="text-black mb-4" >Update Permission:{{$permissions->name}}</h3>
          ...
          <div class="card-body">
            ...
            <div class="row align-items-center pt-3 pb-2">
              ...
              <div class="col-md-9 pe-5">
                ...
                <input type="text" name="name" id="name" class="form-control form-control-sm" value="{{$permissions->name}}"/>
                @if ($errors->has('name'))
            ...
            <option value="{{$permissions->guard_name}}">{{$permissions->guard_name}}</option>   
...
<button type="submit" class="btn btn-primary" style="float:right;margin-right:55px;">Update</button>
        ...
        <a href="{{route('permission.show')}}"style="float:right;margin-top:8px;font-size: 18px;margin-right:15px;text-decoration: none;"><b>Cancel </b></a>
</form>
<!-- @if ($errors->any())
