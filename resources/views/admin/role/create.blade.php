  ...
  <div class="container_fluid">
    <div class="row d-flex justify-content-center align-items-center ">
      <div class="col-xl-11">
        ...
        <h2 class="text-black mb-4" >Create Role</h2>
        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body">
            ...
            <div class="row align-items-center pt-3 pb-2">
              ...
              <label><input type="checkbox" name="permission_id[]" value="{{$permission->id}}">  {{$permission->name}}</label><br>
              @endforeach
...
<button type="submit" class="btn btn-primary" style="float:right;margin-right:55px;">Create</button>
        ...
        <a href="{{route('admin.role.show')}}"style="float:right;margin-top:8px;font-size: 18px;margin-right:15px;text-decoration: none;"><b>Cancel </b></a>
</form>
<!-- @if ($errors->any())
