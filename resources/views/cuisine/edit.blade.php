          ...
          <div class="card-body">
            ...
            <div class="row align-items-center pt-3 pb-2">
              ...
              <div class="col-md-9 pe-5">
                ...
                <input type="text" name="name" id="name" class="form-control form-control-sm" value="{{$cuisines->name}}"/>
                @if ($errors->has('name'))
...
<button type="submit" class="btn btn-primary" style="float:right;margin-right:55px;">Update</button>
        ...
        <a href="{{route('cuisine.show')}}"style="float:right;margin-top:8px;font-size: 18px;margin-right:15px;text-decoration: none;"><b>Cancel </b></a>
</form>
<!-- @if ($errors->any())
